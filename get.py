...
def get_specs_city(ville):
    response = requests.get(f'https://data.economie.gouv.fr/api/explore/v2.1/catalog/datasets/prix-des-carburants-en-france-flux-instantane-v2/records?where="{ville.lower()}"&limit=-1')
    data_dict = json.loads(response.text)
    return data_dict
